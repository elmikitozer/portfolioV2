  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 20% 80%, rgba(139,92,246,0.15) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(99,102,241,0.1) 0%, transparent 50%)',
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <div
          ref={lineRef}
          className="h-px bg-gradient-to-r from-transparent via-indigo-500 to-transparent mb-12 opacity-60"
        />

        <h1
          ref={nameRef}
          className="glitch text-6xl md:text-8xl lg:text-9xl font-bold tracking-tight mb-6"
        ...
        >
          <a
            ...
            className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-full transition-all duration-200 hover:shadow-lg hover:shadow-indigo-500/25 hover:-translate-y-0.5"
          >
            Voir mes projets
          </a>
          <a
            ...
            className="px-6 py-3 border border-white/10 hover:border-white/30 text-white/70 hover:text-white text-sm font-medium rounded-full transition-all duration-200 hover:-translate-y-0.5"
          >
            GitHub
          </a>
        </div>
